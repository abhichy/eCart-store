...
To create an eCart-store store, you’ll need to create a database and have the storefront itself with middleware. The database will contain information on products. In the 
